'''---
title: 공개 데이터셋 종합 실습 (titanic / iris / diabetes)
level: 4
difficulty: ★★☆
summary: 사내 데이터 없이도 연습할 수 있도록, 잘 알려진 3개 데이터셋으로 전처리·파생·요약의 전 과정을 한 번에 훑습니다.
data: [titanic.csv, iris.csv, diabetes_train.csv]
inputs:
  input_titanic:
    file: titanic.csv
  input_iris:
    file: iris.csv
  input_diabetes:
    file: diabetes_train.csv
outputs: [output_titanic, output_iris, output_diabetes]
---
## 시나리오
