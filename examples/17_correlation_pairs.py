'''---
title: 상관 매트릭스를 "쌍(pair) 테이블"로 뒤집기
level: 4
difficulty: ★★☆
summary: 20×20 상관 매트릭스에서 의미 있는 상관쌍만 뽑아 랭킹 테이블로 만듭니다. 센서가 많을수록 강력해집니다.
data: [equipment_sensor_wide.csv]
inputs:
  input:
    file: equipment_sensor_wide.csv
  min_abs_r: 0.7
outputs: [output, output_pairs]
---
## 시나리오
