...
# 11. 이상치 탐지 4종 비교 (IQR / Z / MAD / Hampel)
{: .no_toc }

**난이도** ★★★ · **Level 3 · 시계열과 공정 분석**

같은 데이터에 네 가지 이상치 기준을 동시에 적용해 결과를 비교하고, 몇 개 기준에서 걸렸는지로 신뢰도를 매깁니다.

사용 데이터: [`fab_measurement.csv`](https://github.com/cozytk/spotfire-data-function/blob/main/data/fab_measurement.csv) · [스크립트 원본](https://github.com/cozytk/spotfire-data-function/blob/main/examples/11_outlier_detect.py)
