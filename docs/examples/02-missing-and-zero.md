...
dropna 3종 세트. "0이 있는 행 지우기"를 전체 컬럼에 적용하면 왜 위험한지, 어떻게 고쳐야 하는지까지.

사용 데이터: [`fab_measurement.csv`](https://github.com/cozytk/spotfire-data-function/blob/main/data/fab_measurement.csv) · [스크립트 원본](https://github.com/cozytk/spotfire-data-function/blob/main/examples/02_missing_and_zero.py)
