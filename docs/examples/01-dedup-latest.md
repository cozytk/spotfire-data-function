---
title: 01. 중복 행 제거와 "키 기준 최신값만 남기기"
parent: 예제 모음
nav_order: 1
---

# 01. 중복 행 제거와 "키 기준 최신값만 남기기"
{: .no_toc }

**난이도** ★☆☆ · **Level 1 · 정제 기초**

Spotfire에 아예 없는 기능 1순위. 완전 중복 제거에서 시작해, 같은 키의 재측정 이력 중 최신 1건만 남기는 데까지 확장합니다.

사용 데이터: [`fab_measurement.csv`](https://github.com/cozytk/spotfire-data-function/blob/main/data/fab_measurement.csv) · [스크립트 원본](https://github.com/cozytk/spotfire-data-function/blob/main/examples/01_dedup_latest.py)
...
| 출력 | `output_removed` | Table | 새 데이터 테이블 |
