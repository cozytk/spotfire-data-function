---
title: 08. 결측치를 "지우지 않고" 똑똑하게 채우기
parent: 예제 모음
nav_order: 8
---

# 08. 결측치를 "지우지 않고" 똑똑하게 채우기
{: .no_toc }

**난이도** ★★☆ · **Level 2 · 재구조화**

그룹 중앙값 대치, 시간 기반 선형 보간, 앞/뒤 값 채움을 컬럼 성격에 맞게 골라 적용하고, 무엇을 채웠는지 흔적을 남깁니다.

사용 데이터: [`fab_measurement.csv`](https://github.com/cozytk/spotfire-data-function/blob/main/data/fab_measurement.csv) · [스크립트 원본](https://github.com/cozytk/spotfire-data-function/blob/main/examples/08_impute_smart.py)
...
| 입력 | `max_gap` | Value | 문서 속성 (예: `3`) |
| 출력 | `output` | Table | 새 데이터 테이블 |
| 출력 | `output_report` | Table | 새 데이터 테이블 |
