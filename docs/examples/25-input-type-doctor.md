---
title: 25. 입력 타입 진단기 — "왜 내 코드가 Spotfire에서만 터지나"
parent: 예제 모음
nav_order: 25
---

# 25. 입력 타입 진단기 — "왜 내 코드가 Spotfire에서만 터지나"
{: .no_toc }

**난이도** ★☆☆ · **Level 1 · 정제 기초**

Spotfire가 실제로 넘겨준 컬럼 타입을 표로 뽑아 보고, .dt 오류를 일으키는 시각 컬럼 등을 자동으로 정규화합니다. 새 데이터 함수를 만들 때 맨 처음 붙여 보는 도구입니다.

사용 데이터: [`fab_measurement.csv`](https://github.com/cozytk/spotfire-data-function/blob/main/data/fab_measurement.csv) · [스크립트 원본](https://github.com/cozytk/spotfire-data-function/blob/main/examples/25_input_type_doctor.py)
...
| 출력 | `output_schema` | Table | 새 데이터 테이블 |
